      ...
      <div className='max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24 flex flex-col items-center gap-10 lg:gap-24'>
        <div className='flex flex-col items-center gap-4 text-center'>
          <div className='relative flex flex-col items-center'>
            <img src='/images/element.svg' alt='Element' className='absolute -top-10' />
            <h2 className='font-heading text-lg font-bold text-red-500'>Testimonial</h2>
          </div>
          <h3 className='font-heading text-3xl md:text-4xl font-bold text-neutral-900 max-w-md'>
            ...
            >
              <div className='flex items-center gap-4'>
                ...
                <div className='flex flex-col gap-3'>
                  ...
                  <img src={testimonial.stars} alt='Stars' className='h-5' />
                </div>
              </div>
